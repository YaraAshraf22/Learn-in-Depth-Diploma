...
void LCD_WRITE_COMMAND (unsigned char command)
{
	...
	//MCAL_GPIO_WritePort(LCD_Data_GPIO, ((uint8_t)(LCD_Data_GPIO->IDR) & 0x0F) | (command & 0xF0));
	MCAL_GPIO_WritePort(LCD_Data_GPIO, ((uint8_t)(MCAL_GPIO_ReadPort(LCD_Data_GPIO)) & 0x0F) | (command & 0xF0));
	MCAL_GPIO_WritePin(LCD_CTRL_GPIO, RS_SWITCH, GPIO_PIN_RESET);
	MCAL_GPIO_WritePin(LCD_CTRL_GPIO, RW_SWITCH, GPIO_PIN_RESET);
	wait_ms(1);
	LCD_KICK();
	...
	//MCAL_GPIO_WritePort(LCD_Data_GPIO, ((uint8_t)(LCD_Data_GPIO->IDR) & 0x0F) | (command << 4));
	MCAL_GPIO_WritePort(LCD_Data_GPIO, ((uint8_t)(MCAL_GPIO_ReadPort(LCD_Data_GPIO)) & 0x0F) | (command << 4));
	MCAL_GPIO_WritePin(LCD_CTRL_GPIO, RS_SWITCH, GPIO_PIN_RESET);
	MCAL_GPIO_WritePin(LCD_CTRL_GPIO, RW_SWITCH, GPIO_PIN_RESET);
	wait_ms(1);
	LCD_KICK();
...
void LCD_WRITE_CHAR (unsigned char data)
{
	...
	MCAL_GPIO_WritePort(LCD_Data_GPIO, ((uint8_t)(MCAL_GPIO_ReadPort(LCD_Data_GPIO)) & 0x0F) | (data & 0xF0));
	...
	MCAL_GPIO_WritePort(LCD_Data_GPIO, ((uint8_t)(MCAL_GPIO_ReadPort(LCD_Data_GPIO)) & 0x0F) | (data << 4));
